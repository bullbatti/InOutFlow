...
@Component({
  ...
  standalone: true,
  imports: [CardModule, ChartModule, TooltipModule],
    ...
    this.trackingService.getCurrentYearPercentages().subscribe({
        ...
        this.data = {
          ...
          datasets: [
            ...
            },
            {
              ...
              label: 'Early exits',
              backgroundColor:
                documentStyleSecond.getPropertyValue('--green-500'),
              data: resp[3],
            },
          ],
        };
      ...
      error: (err: Error) => {
        this.messageService.add({
          ...
          summary: 'Error',
          detail:
            'Error retreiving current year data. Please try reloading the page or fill the form to request assistance',
        });
